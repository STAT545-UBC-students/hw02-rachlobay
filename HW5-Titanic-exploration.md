...
Assuming tidyverse is already installed, simply load tidyverse using the R code in the code block below.

If you do not have tidyverse installed as we did in class, simply type install.packages("tidyverse") **before** typing library(tidyverse).
...
![](HW5-Titanic-exploration_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
![](HW5-Titanic-exploration_files/figure-html/unnamed-chunk-24-1.png)<!-- -->
